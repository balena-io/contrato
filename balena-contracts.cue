...
#ContractRequirement: #ContractRange | {or: [...#ContractRequirement]} | {not: [...#ContractRequirement]}
...
#ContractMetadata: {
	...
	// or capabilities an entity defined by the contract provides.
	//
...
#Contract: {
	...
	type: #Type
	// Unique identifier for the contract. No two contracts of the same type may have the same slug
	//
